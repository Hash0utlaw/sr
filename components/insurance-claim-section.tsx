      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-orange-300 max-w-2xl mx-auto">
            We specialize in helping homeowners secure full roof replacements through insurance approvals, saving you time, stress, and money.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-black p-6 rounded-lg shadow-lg">
            ...
            <p className="text-orange-300">We handle the entire insurance claim process, from inspection to approval.</p>
          </div>
          <div className="bg-black p-6 rounded-lg shadow-lg">
            ...
            <p className="text-orange-300">Our thorough inspections and claim filing service are completely free of charge.</p>
          </div>
          <div className="bg-black p-6 rounded-lg shadow-lg">
            ...
            <p className="text-orange-300">Upgrade your shingles for free, potentially lowering your insurance premium.</p>
          </div>
        </div>
        <div className="text-center mt-12">
          <Link href="/insurance-replacement" className="bg-orange-500 text-black px-6 py-3 rounded-full hover:bg-orange-600 transition-colors">
